    ...
    <nav className="bg-kwhite fixed w-full z-10 top-0 border-b border-kgold dark:bg-kdark">
      ...
      <div className="justify-end hidden lg:flex text-kgold  space-x-6 text-right px-4 py-2 text-xl font-medium ">
        ...
        <button
          ...
          type="button"
          className=" hover:scale-150 transition-all duration-200 inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-kdark rounded-lg hover:bg-kgold focus:outline-none focus:ring-2 focus:ring-kgold dark:text-kgold dark:hover:bg-kdark dark:focus:ring-kdark lg:hidden"
          ...
          <div className="absolute top-[64px] w-full left-0 bg-kgold rounded-b-lg shadow-lg">
            <ul className="flex flex-col items-end text-right text-xl font-medium space-y-2 py-4 px-6">
              <li>
                <a
                  href="#home"
                  className="block text-black hover:bg-kgold hover:bg-white py-2 px-4 rounded-lg hover:scale-110"
                >
                  Home
                </a>
              </li>
